"""Synthetic public-API reproduction; all task files are confined to /private/tmp.
...
try:
    ...
    assert result["reason_code"] == "HANDOFF_CONTROLLER_AUTHORIZATION_REQUIRED", result
    assert result["launch_allowed"] is False and before == after
finally:
    fixture.close()
